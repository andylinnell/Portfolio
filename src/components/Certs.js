...
import adobeillu from "../assets/certs/adobeillu.webp"
    ...
    return (
        <div id="certs" className="mt-4 text-white" style={{ paddingBottom: "50px" }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 justify-center mt-4 gap-5">
                ...
                <CertCard name="Adobe Illustrator 2023 Essential Training" img={adobeillu} issued="LinkedIn Learning" date="June 2023" />
